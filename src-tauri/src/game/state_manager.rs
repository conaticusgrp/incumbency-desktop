    ...
    pub fn emit_daily_events(&self, app_handle: Option<&AppHandle>) {
        ...
        update_app(
            ...
            json!({
                ...
                "population_graph_data": get_daily_data(&self.population_graph_data, false),
                "births_graph_data": get_daily_data(&self.births_graph_data, true),
                "deaths_graph_data": get_daily_data(&self.deaths_graph_data, true),
                "life_expectancy_graph_data": get_daily_data(&self.life_expectancy_graph_data, false),
                "hospital_usage_capacity_graph_data": get_daily_data(&self.hospital_usage_capacity_graph_data, false),
            }),
            app_handle,
            AppUpdateType::Day,
        );
        ...
        update_app(
            ...
            json!({
                ...
                "average_welfare_graph_data": get_daily_data(&self.average_welfare_graph_data, false),
                "average_unemployed_welfare_graph_data": get_daily_data(&self.average_unemployed_welfare_graph_data, false),
            }),
            app_handle,
            AppUpdateType::Day,
        );

...
async fn main() { 
  ...
  .invoke_handler(tauri::generate_handler![create_game, check_save_exists, frontend_ready, app_close, app_open, enable_rule, disable_rule, update_rule, update_tax_rate, update_business_tax_rate, update_healthcare_budget, update_welfare_budget, update_business_budget, update_childcare_capacity, update_adultcare_capacity, update_eldercare_capacity])

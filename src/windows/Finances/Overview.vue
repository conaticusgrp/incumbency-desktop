...
import { useGraphStore } from '../../store/graphs';
...
<template>
  <GraphCard :type="governmentBalance.type" :title="governmentBalance.title" :history="governmentBalance.historical"></GraphCard>
  <GraphCard :type="unemploymentRate.type" :title="unemploymentRate.title" :history="unemploymentRate.historical"></GraphCard>
  <GraphCard :type="governmentLosses.type" :title="governmentLosses.title" :history="governmentLosses.historical"></GraphCard>
</template>

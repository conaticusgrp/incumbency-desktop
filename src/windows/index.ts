...
export const APPS: CreateApp[] = [
    {
        component: Finances,
        tabs: [
            { name: "Overview", component: FinancesOverview },
            { name: "Budgets", component: FinancesBudgets },
        ],
        appName: "Finance",
    ...
    },
    {
        ...
        tabs: [
            { name: "Overview", component: HealthcareOverview },
            { name: "Capacity", component: HealthcareCapacity },
            { name: "Rules", component: HealthcareRules },
        ],
        appName: "Healthcare",
    ...
    },
    {
        component: Welfare,
        tabs: [
            { name: "Overview", component: WelfareOverview },
            { name: "Rules", component: WelfareRules },
        ],
        appName: "Welfare",

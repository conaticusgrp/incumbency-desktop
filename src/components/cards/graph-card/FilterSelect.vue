...
const props = defineProps<{ type: GraphData<any>['type_id'], length: number }>();
...
<template>
  <button v-for="choice in choices" :class="selected === choice ? 'selected' : ''" @click="onSelect(choice)"></button>
</template>

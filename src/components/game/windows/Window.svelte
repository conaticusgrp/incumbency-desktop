        ...
        setTimeout(() => {
            dispatcher("windowEvent", {
                ...
                data: {
                    ...
                    content: `
Hello, ${USERNAME}. You are now in leading position for the country's economy. Gary set the bar high during his incumbency, however, his sex scandal led him to step down from office. My name is Ned, I will be here to guide you during your time in office.

...
export const MIN_WINDOW_WIDTH = new CssNumericalValue(800, "px");
export const MIN_WINDOW_HEIGHT = new CssNumericalValue(200, "px");
export const WINDOW_HEADER_HEIGHT = new CssNumericalValue(25, "px");

export const APP_LIST_WIDTH = new CssNumericalValue(5, "%");
export const APP_LIST_MIN_WIDTH = new CssNumericalValue(150, "px");
...
export const TAB_LIST_WIDTH = new CssNumericalValue(8, "%");
